...
import { ArrowUp, ArrowDown, ArrowLeft, ArrowRight, ChevronRight, Undo2 } from "lucide-react"
                      ...
                      {keyboardShortcuts.map((shortcut, index) => {
                        ...
                        return (
                            ...
                            {shortcut.description}
                              ...
                              <div
                                  className="text-gray-500 dark:text-gray-400 flex-shrink-0 ml-3 flex items-center gap-2">
